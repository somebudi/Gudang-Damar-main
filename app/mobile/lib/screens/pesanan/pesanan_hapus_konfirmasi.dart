...
Future<bool> showPremiumPesananHapusConfirmModal(
  BuildContext context,
  String namaBarang,
  String bahan,
  String idPesanan,
) async {
  final displayId = '#${idPesanan.padLeft(6, '0')}';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: const Center(
                          child: Icon(Icons.shopping_cart, size: 32, color: Color(0xFFBA1A1A)), // error
                        ),
                      ),
                      ...
                      // Description
                      const Text(
                        'Tindakan ini tidak dapat dibatalkan. Konfirmasi penghapusan pesanan.',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontSize: 14,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Center(
                                child: Icon(Icons.shopping_cart, color: Color(0xFF44474E), size: 28), // text-on-surface-variant
                              ),
                            ),
