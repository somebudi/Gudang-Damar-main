...
Future<bool> showPremiumBarangHapusConfirmModal(
  BuildContext context,
  String namaBarang,
  String bahan,
  String idBarang,
) async {
  final displayId = '#${idBarang.padLeft(6, '0')}';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Description
                      const Text(
                        'Tindakan ini tidak dapat dibatalkan. Konfirmasi penghapusan barang.',
                        style: TextStyle(
                          fontFamily: 'Inter',
                          fontSize: 14,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Center(
                                child: Icon(Icons.inventory_2, color: Color(0xFF44474E), size: 28), // text-on-surface-variant
                              ),
                            ),
